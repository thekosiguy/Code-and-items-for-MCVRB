...
recipe1 = pygame.image.load("Recipe Images/Victoria Cake.jpg")
recipe1 = pygame.transform.scale(recipe1, (120, 120))
recipe2 = pygame.image.load("Recipe Images/Lemon Drizzle Cake.jpg")
recipe2 = pygame.transform.scale(recipe2, (120, 120))
recipe3 = pygame.image.load("Recipe Images/Roasted Chicken.jpg")
recipe3 = pygame.transform.scale(recipe3, (120, 120))
recipe4 = pygame.image.load("Recipe Images/Cheesy Bake.jpg")
recipe4 = pygame.transform.scale(recipe4, (120, 120))
recipe5 = pygame.image.load("Recipe Images/Lasagne.jpg")
recipe5 = pygame.transform.scale(recipe5, (120, 120))
recipe6 = pygame.image.load("Recipe Images/Tuna Pasta Bake.jpg")
recipe6 = pygame.transform.scale(recipe6, (120, 120))
recipe7 = pygame.image.load("Recipe Images/Shepherds Pie.jpg")
recipe7 = pygame.transform.scale(recipe7, (120, 120))
recipe8 = pygame.image.load("Recipe Images/Chilli Con Carne.jpg")
recipe8 = pygame.transform.scale(recipe8, (120, 120))
recipe9 = pygame.image.load("Recipe Images/Pepperoni Pizza.jpg")
recipe9 = pygame.transform.scale(recipe9, (120, 120))
recipe10 = pygame.image.load("Recipe Images/Chicken Korma.jpg")
